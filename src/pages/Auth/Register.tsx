  ...
  return (
    <div
      ...
      <div style={{
        ...
        <h2 style={{ textAlign:'center', marginBottom: 32, fontSize: '28px', fontWeight: '600', color: '#4f0f87', letterSpacing: '0.5px' }}>ĐĂNG KÝ THÀNH VIÊN</h2>
        ...
        >
          <Row gutter={16}>
            <Col span={12}>
              ...
              >
                <Input placeholder="Họ và tên" style={{ boxShadow: 'none', borderColor: '#d9d9d9' }} />
              </Form.Item>
            </Col>
            <Col span={12}>
              <Form.Item
          ...
          <Row gutter={16}>
            <Col span={12}>
              ...
              >
                <Input placeholder="Địa chỉ" style={{ boxShadow: 'none', borderColor: '#d9d9d9' }} />
              </Form.Item>
            </Col>
            <Col span={12}>
              <Form.Item
        ...
        <Form.Item style={{ display: 'flex', justifyContent: 'center' }}>
          <div style={{ display: 'flex', gap: '8px' }}>
            ...
            <Button
              style={{ boxShadow: 'none', borderColor: '#d9d9d9' }}
              onClick={() => alert('Chưa tích hợp Facebook!')}
              icon={<img src="https://cdn-icons-png.flaticon.com/512/733/733547.png" style={{ width: 18, height: 18, marginRight: 8 }} />}
              className="flex items-center justify-center px-4 py-2"
            >
              Facebook
            </Button>
            ...
            <Button
              style={{ boxShadow: 'none', borderColor: '#d9d9d9' }}
              onClick={() => alert('Chưa tích hợp GitHub!')}
              icon={<img src="https://cdn-icons-png.flaticon.com/512/733/733553.png" style={{ width: 18, height: 18, marginRight: 8 }} />}
              className="flex items-center justify-center px-4 py-2"
            >
              GitHub
            </Button>
        ...
        <Form.Item wrapperCol={{ span: 24 }} style={{ textAlign: 'center' }}>
          Bạn đã có tài khoản?{" "}
          <Link to="/login" style={{ color: '#4f0f87' }} >
            Đăng nhập
          </Link>{" "}ngay
        </Form.Item>
      </div>
