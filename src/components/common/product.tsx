...
const selectedBooks: Book[] = [
    { title: 'Financial Feminist', author: 'Tori Dunlap', price: '$20.46', image: 'https://picsum.photos/id/1015/200/300' },
    { title: 'No More Police', author: 'Andrea Ritchie', price: '$17.76', image: 'https://picsum.photos/id/1016/200/300' },
    { title: "I'm Glad My Mom Died", author: 'Jennette McCurdy', price: '$28.03', image: 'https://picsum.photos/id/1020/200/300' },
    { title: 'Nona the Ninth', author: 'Tamsyn Muir', price: '$26.96', image: 'https://picsum.photos/id/1035/200/300' },
];

const mustBuyBooks: Book[] = [
    { title: 'Harlem Shuffle', author: 'Colson Whitehead', price: '$26.92', image: 'https://picsum.photos/id/1043/200/300' },
    { title: 'Two Old Women', author: 'Velma Wallis', price: '$13.95', image: 'https://picsum.photos/id/1052/200/300' },
    { title: 'Carrie Soto is Back', author: 'Taylor Jenkins Reid', price: '$26.04', image: 'https://picsum.photos/id/1062/200/300' },
    { title: 'Book Lovers', author: 'Emily Henry', price: '$15.81', image: 'https://picsum.photos/id/1070/200/300' },
];
...
const BookCarousel: React.FC = () => {
    return (
        <div className="max-w-7xl mx-auto py-10 px-4">
            ...
            {/* Selected for you */}
            <h2 className="text-2xl font-bold mb-6 text-left mt-12">Selected for you</h2>
